...
class SnowflakeFeatureIterator(QgsAbstractFeatureIterator):
    def __init__(self, source: "SnowflakeFeatureSource", request):
    ...
    def fetchFeature(self, f: "QgsFeature") -> bool:
        ...
        try:
            found = False
            while not found:
                _f: QgsFeature = self._source._features[
...
class SnowflakeFeatureSource(QgsAbstractFeatureSource):
    def __init__(self, provider: "SnowflakeVectorDataProvider"):
        super(SnowflakeFeatureSource, self).__init__()
    ...
    def getFeatures(self, request):
        return QgsFeatureIterator(SnowflakeFeatureIterator(self, request))


class SnowflakeVectorDataProvider(QgsVectorDataProvider):
    next_feature_id = 1
    ...
    def description(cls):
        ...
        return "Snowflake Vector Data Provider"

    @classmethod
    def createProvider(cls, uri, providerOptions):
        return SnowflakeVectorDataProvider(uri, providerOptions)
    ...
    def __init__(self, uri="", providerOptions=QgsDataProvider.ProviderOptions()):
        ...
        self._wkbType = Qgis.WkbType.Point
        self._features = {}
    ...
    def featureSource(self):
        return SnowflakeFeatureSource(self)

    def dataSourceUri(self, expandAuthConfig=True):
        return self._uri

    def storageType(self):
        return "Snowflake storage"

    def getFeatures(self, request=QgsFeatureRequest()):
        return QgsFeatureIterator(
            SnowflakeFeatureIterator(SnowflakeFeatureSource(self), request)
        )
